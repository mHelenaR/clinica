                    ...
                    <div class="containerForm">
                        <div class="form">
                            <form method="post" action="/login">
                                <label class="label-destaque">Bem-vindo(a)</label><br>
                                <label class="label-destaque">de volta!</label><br>
                                <input class="input-arredondado" id="email" name="email" type="" placeholder="E-mail" /><br><br>
                                <input class="input-arredondado" id="senha" name="senha" type="password" placeholder="Senha" /><br><br>
                                <button class="botao" type="submit" name="btn_Entrar">Entrar</button><br>
                                <label class="label-login" style="color: #BEBEBE;">Ainda não possui uma conta?</label><br>
                                <label class="label-login" style="color: #849CCC;">CADASTRAR-SE</label><br>
                            </form>
                        </div>
                    </div>
                </div>
